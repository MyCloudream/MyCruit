...
<body>
	...
	<script type="text/javascript">
		...
		function ShelfManagerUpd() {
			updateobj(gb("ShelfManagerUpd").name, gb("ShelfManagerUpd").link,"", "");
		}
		function ShelfManagerAdd() {
			addobj(gb("ShelfManagerAdd").name, gb("ShelfManagerAdd").link, "","");
		}
		function ShelfManagerDel() {
			delobj("/busi/ShelfManagerDel.do");
		}
