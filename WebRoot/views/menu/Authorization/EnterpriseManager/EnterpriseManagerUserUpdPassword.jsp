...
<body>
	<form class="formobj" method="post" action="/busi/EnterpriseManagerUpdUser.do?method=updUserPassword">
		<table class="vtb">
			<tr>
			...
			<tr>
				...
				<td><input type="password" name="repassword" recheck="password"
					datatype="*6-28" errormsg="两次输入的密码不一致！" /><span
