...
<body>
	<form class="formobj" method="post" action="/busi/EnterpriseManagerUpdUser.do?method=addUser">
		<table class="vtb">
			<tr>
			...
			<tr>
				...
				<td><input type="password" name="password"
					plugin="passwordStrength" datatype="*6-28"
					errormsg="密码至少6个字符,最多28个符！" /> <span class="passwordStrength">
			...
			<tr>
				...
				<td><input type="password" name="repassword"
					recheck="password" datatype="*6-28" errormsg="两次输入的密码不一致！" /><span
					class="Validform_checktip"> 重复密码</span></td>
			</tr>
		</table>
		<span class="thidden"><input type="hidden" value="Y"
			name="status"><input type="button" id="btn_sub"></span>
	</form>
</body>
</html>