		...
		<form id="ff" method="post">
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<th colspan="2" align="right"><a id="btn" onclick="btn()"
...
function getncode(x){
	...
	function reload() {
		$("#ncode option").remove();
		$("#ncode").append("<option value=''>全部</option>");
		ff[0].reset();
		btn();
	}
	function PartsManagerUpd() {
		updateobj(gb("PartsManagerUpd").name, gb("PartsManagerUpd").link, 1000,
				600);
	}
	function PartsManagerAdd() {
		addobj(gb("PartsManagerAdd").name, gb("PartsManagerAdd").link, 1000,
				600);
	}
	function PartsManagerDel() {
		delobj("/busi/PartsManagerDel.do");
	}
